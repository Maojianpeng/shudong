...
public class JWTUtil {
    ...
    public static String generate(String userId, String username, List<String> role, List<String> authority,
     ...
     */
    public static JWT check(String token, String sign) throws ExpiredJwtException, SignatureException {
