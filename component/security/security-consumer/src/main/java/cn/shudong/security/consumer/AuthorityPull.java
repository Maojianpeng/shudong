package cn.shudong.security.consumer;

import cn.shudong.core.thread.GlobalThreadFactory;
import cn.shudong.core.util.GsonUtil;
import cn.shudong.core.util.HttpUtil;
import cn.shudong.security.core.AuthorityWrapper;
import cn.shudong.security.core.Constants;
        ...
        applicationO.ifPresent(application -> {
            ...
            for (InstanceInfo instanceInfo : clientInstanceList) {
                ...
                try {
                    ...
                    //查询并添加缓存
                    AuthorityWrapper[] authoritys = HttpUtil.get(authorityProviderEndpoint, response -> GsonUtil.getObject(response, AuthorityWrapper[].class));
