...
-- ----------------------------
-- Table structure for t_uaa_authority
-- ----------------------------
DROP TABLE IF EXISTS `t_uaa_authority`;
CREATE TABLE `t_uaa_authority`  (
...
-- ----------------------------
-- Table structure for t_uaa_role
-- ----------------------------
DROP TABLE IF EXISTS `t_uaa_role`;
CREATE TABLE `t_uaa_role`  (
  `id` bigint(20) NOT NULL,
...
-- ----------------------------
-- Table structure for t_uaa_role_authority
-- ----------------------------
DROP TABLE IF EXISTS `t_uaa_role_authority`;
CREATE TABLE `t_uaa_role_authority`  (
  `id` bigint(20) NOT NULL,
...
-- ----------------------------
-- Table structure for t_uaa_user
-- ----------------------------
DROP TABLE IF EXISTS `t_uaa_user`;
CREATE TABLE `t_uaa_user`  (
  `id` bigint(20) NOT NULL,
...
-- ----------------------------
-- Table structure for t_uaa_user_authority
-- ----------------------------
DROP TABLE IF EXISTS `t_uaa_user_authority`;
CREATE TABLE `t_uaa_user_authority`  (
  `id` bigint(20) NOT NULL,
...
-- ----------------------------
-- Table structure for t_uaa_user_role
-- ----------------------------
DROP TABLE IF EXISTS `t_uaa_user_role`;
CREATE TABLE `t_uaa_user_role`  (
  `id` bigint(20) NOT NULL,
